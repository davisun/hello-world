<form class="form" action="<?= $this->postAction; ?>" method="post">
	<div class="alert-danger form-errors"><?= $this->displayErrors?></div>
	<div class="form-row">
	...
	<div class="col-md-12 text-right">
		<a href="<?=PROOT?>contacts" class="btn btn-secondary btn-sm">Cancel</a>
		<?= submitTag('Save',['class'=>'btn btn-primary btn-sm']) ?>
	</div>
	</div>
